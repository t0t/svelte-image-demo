...
<svg style="width: {size}" class:active="{active}" on:click="{() => active = !active}"
    xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" stroke-linejoin="round" clip-rule="evenodd"
    viewBox="0 0 384 247">
    <path fill="none" stroke-dasharray="8.3 8.3" stroke-dashoffset="1.87" stroke-width="1"
