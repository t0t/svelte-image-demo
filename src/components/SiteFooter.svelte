...
<style lang="scss">
  ...
  .grid-container {
    ...
    gap: 1px 1px;
    grid-template-areas: "Brand BrandDescription BrandDescription BrandDescription""SocialLinks SocialLinks SocialLinks SocialLinks""Player Player Player Player";
  }
...
<div class="grid-container">
  ...
  <div class="Brand"></div>
  <div class="BrandDescription"></div>
